...
export const morphNoiseFragShader = `
uniform vec3 color;
...
export const morphNoiseVertexShader = `
...
`
export const morphBasicFragShader=`
uniform vec3 color;
uniform vec3 diffuse;
uniform float opacity;
...
`
export const morphBasicVertexShader=`
uniform float size;
uniform float scale;
...
`
export const morphShaderUniforms = Object.freeze({
  uTime: {
    value: 0
  },
  uProgress: {
