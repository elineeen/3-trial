import {Vector2,Color,TextureLoader} from 'three'
export const curlNoise2DVertexShader=`
       vec4 permute(vec4 x){return mod(((x*34.)+1.)*x,289.);}
        ...
        `;
export const curl3DNoiseVertexShader=`
       vec4 permute(vec4 x){return mod(((x*34.)+1.)*x,289.);}
        vec4 taylorInvSqrt(vec4 r){return 1.79284291400159-.85373472095314*r;}
        ...
        `;
export const curlNoiseFragmentShader=`
        uniform float uTime;
        uniform vec2 uMouse;
...
export const curlNoiseUniforms=Object.freeze({
    uTime: {
        value: 0
    },
    uMouse: {
    ...
    uTexture: {
        value:  new TextureLoader().load( '/wp5723479.png' )
    },
    color: { value: new Color( 0xffffff ) },
});

export const particleExplodeVertexShader = `
vec4 permute(vec4 x){return mod(((x*34.)+1.)*x,289.);}
vec4 taylorInvSqrt(vec4 r){return 1.79284291400159-.85373472095314*r;}
...
export const particleExplodeFragmentShader = `
uniform float uTime;
uniform vec2 uMouse;
uniform vec2 uResolution;
